...
final class IrregularTrackerVC: UIViewController {
    // MARK: - Delegates
    ...
    @objc private func createTapped() {
        // Для нерегулярного трекера расписание пустое []
        guard
        ...
        do {
            ...
            delegate?.passingTracker(newTracker, selectedCategoryTitle)
            dismiss(animated: true)
        } catch {
...
extension IrregularTrackerVC: UITextFieldDelegate {
...
// MARK: - UITableViewDataSource / Delegate (Категория)
extension IrregularTrackerVC: UITableViewDataSource, UITableViewDelegate {
...
// MARK: - UICollectionViewDataSource / Delegate (Эмоджи / Цвета)
extension IrregularTrackerVC: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
extension IrregularTrackerVC: EmojiCellDelegate, ColorCellDelegate {
...
extension IrregularTrackerVC: CategoryViewControllerDelegate {
