...
class IrregularTrackerVC: UIViewController {
    weak var delegate: TrackerCreationProtocol?
    internal var selectedCategory: String = "По умолчанию"
    ...
    private let colors: [UIColor] = [
        .colorSection1, .colorSection2, .colorSection3,
        .colorSection4, .colorSection5, .colorSection6,
        .colorSection7, .colorSection8, .colorSection9,
        .colorSection10, .colorSection11, .colorSection12,
        .colorSection13, .colorSection14, .colorSection15,
        .colorSection16, .colorSection17, .colorSection18
    ]
    ...
    private let trackerCategory = TrackerCategoryStore.shared
    ...
    func setupUI() {
        ...
        mainCollectionView.register(IrregularEventCell.self, forCellWithReuseIdentifier: IrregularEventCell.reuseIdentifier)
    ...
    @objc func createButtonTapped() {
        ...
        let newTracker = Tracker(id: UUID(), name: name, color: color, emoji: emoji, schedule: [])
        do {
            try trackerStore.addTracker(newTracker, categoryTitle: "По умолчанию")
            delegate?.passingTracker(newTracker, "По умолчанию")
            dismiss(animated: true)
        } catch {
...
extension IrregularTrackerVC: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 0:
            ...
            return cell
        case 1:
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: IrregularEventCell.reuseIdentifier, for: indexPath) as! IrregularEventCell
            return cell
        case 2:
...
extension IrregularTrackerVC: UICollectionViewDelegateFlowLayout {
...
extension IrregularTrackerVC: ColorCellDelegate {
    func didSelectColor(_ color: UIColor) {
        selectedColor = color
    }
}

extension IrregularTrackerVC: EmojiCellDelegate {
    func didSelectEmoji(_ emoji: String) {
        selectedEmoji = emoji
    }
}

extension IrregularTrackerVC: TextFieldCollectionViewCellDelegate {
